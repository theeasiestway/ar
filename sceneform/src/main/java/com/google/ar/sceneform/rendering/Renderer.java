...
public class Renderer implements UiHelper.RendererCallback {
  ...
  private Viewport mirrorViewport = new Viewport(0, 0, 0, 0); // it's my changes to get rid of allocations 13.02.23
  ...
  private Viewport getLetterboxViewport(Viewport srcViewport, Viewport destViewport) {
    ...
    mirrorViewport.left = left;
    mirrorViewport.bottom = bottom;
    mirrorViewport.width = width;
    mirrorViewport.height = height;
